...
namespace Mirror
{
    public abstract class NetworkTransformBase : NetworkBehaviour, IOnGUI
    {
...
// OnGUI allocates even if it does nothing. avoid in release.
        ...
        bool IOnGUI.IsAlive() => gameObject != null;
        bool IOnGUI.IsVisible() => showOverlay;

        public virtual void OnGUIAction()
        {
